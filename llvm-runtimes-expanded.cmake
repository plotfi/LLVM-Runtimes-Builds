...
set(target x86_64-unknown-linux-android)
set(BUILTINS_${target}_CMAKE_BUILD_TYPE RelWithDebInfo CACHE STRING "")
set(BUILTINS_${target}_CMAKE_C_FLAGS "-isystem ${TOOLCHAIN_SOURCE_DIR}/sysroots/android-x86_64/usr/include/x86_64-linux-android -D__ANDROID_API__=21" CACHE STRING "")
set(BUILTINS_${target}_CMAKE_SYSROOT "${TOOLCHAIN_SOURCE_DIR}/sysroots/android-x86_64" CACHE STRING "")
# TODO(abdulras) replace with Android when we can replace the sysroot
set(BUILTINS_${target}_CMAKE_SYSTEM_NAME Linux CACHE STRING "")
set(BUILTINS_${target}_CMAKE_SYSTEM_PROCESSOR x86_64 CACHE STRING "")
set(BUILTINS_${target}_CMAKE_TRY_COMPILE_TARGET_TYPE STATIC_LIBRARY CACHE STRING "")
...
# TODO(abdulras) replace with Android when we can replace the sysroot
set(RUNTIMES_${target}_CMAKE_SYSTEM_NAME Linux CACHE STRING "")
set(RUNTIMES_${target}_CMAKE_SYSROOT "${TOOLCHAIN_SOURCE_DIR}/sysroots/android-x86_64" CACHE STRING "")
set(RUNTIMES_${target}_CMAKE_SHARED_LINKER_FLAGS "-fuse-ld=lld" CACHE STRING "")
set(RUNTIMES_${target}_CMAKE_MODULE_LINKER_FLAGS "-fuse-ld=lld" CACHE STRING "")
set(RUNTIMES_${target}_CMAKE_EXE_LINKER_FLAGS "-fuse-ld=lld" CACHE STRING "")
set(RUNTIMES_${target}_LLVM_ENABLE_ASSERTIONS ON CACHE BOOL "")
